...
3. **Implement Feature:**
   - Write the application code to meet the task's requirements as defined in the `spec.md`.
...
### Daily Development
```bash
# Example: Commands for common daily tasks (e.g., start dev server, run linter, format)
...
3. Manually verify fix, including on mobile
