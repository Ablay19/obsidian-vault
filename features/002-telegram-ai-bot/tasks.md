...
- [ ] T002 Initialize Go project with required dependencies in go.mod
- [ ] T003 [P] Configure linting and formatting tools (golangci-lint, gofmt)
- [ ] T004 [P] Setup environment configuration management in internal/config/
- [ ] T005 [P] Initialize logging infrastructure in pkg/utils/logger.go
...
- [ ] T006 Setup database schema and migrations for SQLite in internal/storage/
- [ ] T007 [P] Implement Telegram bot framework and basic message handling in internal/bot/
- [ ] T008 [P] Setup Redis caching layer in internal/storage/cache.go
- [ ] T009 Create base models (User, Conversation, Message) in internal/models/
- [ ] T010 Configure error handling and middleware infrastructure in internal/bot/middleware.go
- [ ] T011 Setup rate limiting framework in pkg/utils/rate_limiter.go
- [ ] T012 Create AI orchestration engine structure in internal/ai/orchestrator.go
...
- [ ] T013 [P] [US1] Create User model in internal/models/user.go
- [ ] T014 [P] [US1] Create Conversation model in internal/models/conversation.go
- [ ] T015 [P] [US1] Create Message model in internal/models/message.go
- [ ] T016 [US1] Implement UserService in internal/storage/user.go (depends on T013)
- [ ] T017 [US1] Implement ConversationService in internal/storage/conversation.go (depends on T014, T015)
- [ ] T018 [US1] Implement local GPT-2 model integration in internal/ai/local/gpt2.go
- [ ] T019 [US1] Implement AI model manager in internal/ai/local/manager.go (depends on T018)
- [ ] T020 [US1] Implement context management in internal/ai/context.go (depends on T016, T017)
...
- [ ] T023 [US1] Create bot entry point in cmd/bot/main.go
- [ ] T024 [US1] Add conversation history persistence in internal/storage/conversation.go
- [ ] T025 [US1] Add response formatting and markdown support in internal/bot/handler.go
