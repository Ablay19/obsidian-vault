...
func APIKeysPanel(keys []state.APIKeyState, providers []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, key := range keys {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/dashboard/api_keys_panel.templ`, Line: 109, Col: 94}
			}
			...
			if key.Value != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/dashboard/api_keys_panel.templ`, Line: 112, Col: 32}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/dashboard/api_keys_panel.templ`, Line: 143, Col: 10}
			}
		...
		for _, p := range providers {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/dashboard/api_keys_panel.templ`, Line: 184, Col: 24}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/dashboard/api_keys_panel.templ`, Line: 184, Col: 61}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "</select> <input x-model=\"keyValue\" required type=\"password\" placeholder=\"API_SECRET_KEY\" class=\"col-span-2 bg-gray-900 text-white text-[10px] font-mono rounded-lg px-3 py-2 border border-gray-800 focus:ring-1 focus:ring-blue-500 outline-none\"></div><button :disabled=\"loading || !providerName || !keyValue\" type=\"submit\" class=\"w-full bg-blue-600 hover:bg-blue-500 disabled:bg-gray-800 text-white p-2.5 rounded-lg transition-all font-bold text-[9px] uppercase tracking-widest flex items-center justify-center\"><span x-show=\"!loading\">Inject Access Key</span> <span x-show=\"loading\" class=\"material-icons animate-spin text-xs\">sync</span></button></form></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
